...
Source0  : https://download.kde.org/stable/plasma/5.16.3/sddm-kcm-5.16.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.3/sddm-kcm-5.16.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562737493
mkdir -p clr-build
pushd clr-build
