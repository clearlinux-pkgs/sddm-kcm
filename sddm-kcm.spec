...
Version  : 6.2.4
Release  : 97
URL      : https://download.kde.org/stable/plasma/6.2.4/sddm-kcm-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/sddm-kcm-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/sddm-kcm-6.2.4.tar.xz.sig
...
%setup -q -n sddm-kcm-6.2.4
cd %{_builddir}/sddm-kcm-6.2.4
pushd ..
cp -a sddm-kcm-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735256075
mkdir -p clr-build
pushd clr-build
