...
Version  : 5.27.10
Release  : 78
URL      : https://download.kde.org/stable/plasma/5.27.10/sddm-kcm-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/sddm-kcm-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/sddm-kcm-5.27.10.tar.xz.sig
...
%prep
%setup -q -n sddm-kcm-5.27.10
cd %{_builddir}/sddm-kcm-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702973271
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/V3/usr/lib64/libexec/kauth/kcmsddm_authhelper
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt5/plugins/plasma/kcms/systemsettings/kcm_sddm.so
