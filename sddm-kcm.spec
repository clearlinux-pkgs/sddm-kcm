...
Version  : 6.3.2
Release  : 102
URL      : https://download.kde.org/stable/plasma/6.3.2/sddm-kcm-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/sddm-kcm-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/sddm-kcm-6.3.2.tar.xz.sig
...
%setup -q -n sddm-kcm-6.3.2
cd %{_builddir}/sddm-kcm-6.3.2
pushd ..
cp -a sddm-kcm-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740680635
mkdir -p clr-build
pushd clr-build
