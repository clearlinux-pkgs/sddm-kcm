...
Version  : 6.1.2
Release  : 90
URL      : https://download.kde.org/stable/plasma/6.1.2/sddm-kcm-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/sddm-kcm-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/sddm-kcm-6.1.2.tar.xz.sig
...
%setup -q -n sddm-kcm-6.1.2
cd %{_builddir}/sddm-kcm-6.1.2
pushd ..
cp -a sddm-kcm-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720588849
mkdir -p clr-build
pushd clr-build
