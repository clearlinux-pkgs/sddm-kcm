...
Source0  : https://download.kde.org/stable/plasma/5.16.4/sddm-kcm-5.16.4.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.16.4/sddm-kcm-5.16.4.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564517761
mkdir -p clr-build
pushd clr-build
