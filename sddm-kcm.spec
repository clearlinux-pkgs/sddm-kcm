...
Version  : 6.0.0
Release  : 79
URL      : https://download.kde.org/stable/plasma/6.0.0/sddm-kcm-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/sddm-kcm-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/sddm-kcm-6.0.0.tar.xz.sig
...
%prep
%setup -q -n sddm-kcm-6.0.0
cd %{_builddir}/sddm-kcm-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709333962
mkdir -p clr-build
pushd clr-build
