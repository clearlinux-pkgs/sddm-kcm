...
Version  : 5.23.4
Release  : 46
URL      : https://download.kde.org/stable/plasma/5.23.4/sddm-kcm-5.23.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.4/sddm-kcm-5.23.4.tar.xz
...
%prep
%setup -q -n sddm-kcm-5.23.4
cd %{_builddir}/sddm-kcm-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638354648
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sddm-kcm-5.23.4/COPYING %{buildroot}/usr/share/package-licenses/sddm-kcm/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/sddm-kcm-5.23.4/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/sddm-kcm/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/sddm-kcm-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/sddm-kcm/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/sddm-kcm-5.23.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/sddm-kcm/e3bdbf20d43fc066a1b40a64d57d4ae5a31f177f
cp %{_builddir}/sddm-kcm-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/sddm-kcm/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/sddm-kcm-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/sddm-kcm/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
