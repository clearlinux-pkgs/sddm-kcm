...
Version  : 5.17.2
Release  : 17
URL      : https://download.kde.org/stable/plasma/5.17.2/sddm-kcm-5.17.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.17.2/sddm-kcm-5.17.2.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.2/sddm-kcm-5.17.2.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572393889
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sddm-kcm-5.17.2/COPYING %{buildroot}/usr/share/package-licenses/sddm-kcm/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
%find_lang kcm_sddm
