...
Source0  : https://download.kde.org/stable/plasma/5.16.2/sddm-kcm-5.16.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.2/sddm-kcm-5.16.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1561484789
mkdir -p clr-build
pushd clr-build
