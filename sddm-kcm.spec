...
Source0  : https://download.kde.org/stable/plasma/5.27.2/sddm-kcm-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/sddm-kcm-5.27.2.tar.xz.sig
...
%prep
%setup -q -n sddm-kcm-5.27.2
cd %{_builddir}/sddm-kcm-5.27.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677599902
mkdir -p clr-build
pushd clr-build
